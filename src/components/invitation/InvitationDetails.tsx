...
export function InvitationDetails() {
  return (
    <section className="py-8 space-y-6">
      <div className="flex flex-row flex-wrap items-center justify-center text-center font-dulcinea text-3xl text-primary">
         <p>Sábado</p>
         <DateSeparator />
         <p>08 de noviembre</p>
         <DateSeparator />
      ...
      <div className="text-center text-foreground/80 text-lg leading-relaxed max-w-prose mx-auto font-lato font-thin italic">
        <p>
