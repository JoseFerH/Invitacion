...
const stars = [
  ...
  { asset: 3, top: '15%', right: '15%', scale: 1.1, opacity: 0.85, duration: 4.2, delay: 0.8 }, // Increased scale
  { asset: 3, top: '85%', left: '5%', scale: 1.3, opacity: 0.95, duration: 5.8, delay: 2.2 }, // Increased scale
  { asset: 4, top: '30%', right: '40%', scale: 1, opacity: 0.75, duration: 3.8, delay: 1.1 }, // Increased scale
  { asset: 4, top: '65%', left: '35%', scale: 1.1, opacity: 0.9, duration: 6.5, delay: 4.5 }, // Increased scale
  ...
  { asset: 3, top: '45%', right: '5%', scale: 1.2, opacity: 0.9, duration: 4.8, delay: 1.3 }, // Increased scale
  { asset: 4, top: '5%', left: '30%', scale: 0.9, opacity: 0.7, duration: 3.6, delay: 0.9 }, // Increased scale
  ...
  { asset: 3, top: '50%', left: '2%', scale: 1, opacity: 0.8, duration: 4.6, delay: 1.7 }, // Increased scale
  { asset: 4, top: '22%', right: '28%', scale: 1.1, opacity: 0.85, duration: 6.8, delay: 4.2 }, // Increased scale
  // New star added to top right
  { asset: 4, top: '8%', right: '8%', scale: 1.1, opacity: 0.9, duration: 5, delay: 0.5 },
];
